...
public:
    ...
    explicit chameleon_isrp_impl(uhd::device::sptr dev) : _dev(std::move(dev)), _seq(0)
    {
    ...
    uhd::device::sptr get_device() override { return _dev; }

    uhd::rx_streamer::sptr get_rx_stream(const uhd::stream_args_t& args) override { return _dev->get_rx_stream(_stream_args); }

    uhd::tx_streamer::sptr get_tx_stream(const uhd::stream_args_t& args) override { return _dev->get_tx_stream(_stream_args); }

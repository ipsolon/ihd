...
from gnuradio import chameleon
...
class ChameleonFFT(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ChameleonFFT")
        ...
        self.connect((self.chameleon_chameleon_fft_0, 0), (self.blocks_stream_to_vector_0, 0))
...
def main(top_block_cls=ChameleonFFT, options=None):

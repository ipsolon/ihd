...
class fft_generate(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fft_generate")
        ...
        self.fft_vxx_0 = fft.fft_vcc(rec_len, True, window.blackmanharris(1024), True, 1)
...
def main(top_block_cls=fft_generate, options=None):

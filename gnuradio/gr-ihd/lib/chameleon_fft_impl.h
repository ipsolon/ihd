...
#ifndef INCLUDED_IHD_CHAMELEON_FFT_IMPL_H
#define INCLUDED_IHD_CHAMELEON_FFT_IMPL_H

#include <gnuradio/ihd/chameleon_fft.h>
#include "ihd.h"
...
#endif /* INCLUDED_IHD_CHAMELEON_FFT_IMPL_H */

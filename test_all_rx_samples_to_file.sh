...
if [[ $FILESIZE != $FILE_SIZE_256_FFT ]]; then let "file_size_errors=file_size_error+1"; echo -e "\n***ERROR2 \n\n"; fi
...
ls -al isrp_samples.dat
FILESIZE=$(stat -c%s "$FILENAME")
if [[ $FILESIZE != $FILE_SIZE_512_FFT ]]; then let "file_size_errors=file_size_error+1"; echo -e "\n***ERROR8 \n\n"; fi
...
ls -al isrp_samples.dat
FILESIZE=$(stat -c%s "$FILENAME")
if [[ $FILESIZE != $FILE_SIZE_1024_FFT ]]; then let "file_size_errors=file_size_error+1"; echo -e "\n***ERROR14 \n\n"; fi
...
ls -al isrp_samples.dat
FILESIZE=$(stat -c%s "$FILENAME")
if [[ $FILESIZE != $FILE_SIZE_2048_FFT ]]; then let "file_size_errors=file_size_error+1"; echo -e "\n***ERROR \n\n"; fi
...
ls -al isrp_samples.dat
FILESIZE=$(stat -c%s "$FILENAME")
if [[ $FILESIZE != $FILE_SIZE_4096_FFT ]]; then let "file_size_errors=file_size_error+1"; echo -e "\n***ERROR \n\n"; fi

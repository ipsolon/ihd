...
#if [ $# -eq 0 ];`
#then
let "NUM_SAMPS=1000000"
#fi
#if [ $#1 -eq 1 ];
#    let "NUM_SAMPS=$1";
#fi

FILE_SIZE_256_FFT=399360
...
ret_code=$?
if [ $ret_code != 0 ]; then let "errors=errors+1";  echo -e "***ERROR\n\n"; fi
ls -al isrp_samples.dat
FILESIZE=$(stat -c%s "$FILENAME")
if [[ $FILESIZE != $FILE_SIZE_256_FFT ]]; then let "file_size_errors=file_fize_error+1"; echo -e "\n***ERROR \n\n"; fi
...
ls -al isrp_samples.dat
FILESIZE=$(stat -c%s "$FILENAME")
if [[ $FILESIZE != $FILE_SIZE_512_FFT ]]; then let "file_size_errors=file_fize_error+1"; echo -e "\n***ERROR \n\n"; fi
...
ls -al isrp_samples.dat
FILESIZE=$(stat -c%s "$FILENAME")
if [[ $FILESIZE != $FILE_SIZE_1024_FFT ]]; then let "file_size_errors=file_fize_error+1"; echo -e "\n***ERROR \n\n"; fi
...
ls -al isrp_samples.dat
FILESIZE=$(stat -c%s "$FILENAME")
if [[ $FILESIZE != $FILE_SIZE_2048_FFT ]]; then let "file_size_errors=file_fize_error+1"; echo -e "\n***ERROR \n\n"; fi
...
ls -al isrp_samples.dat
FILESIZE=$(stat -c%s "$FILENAME")
if [[ $FILESIZE != $FILE_SIZE_4096_FFT ]]; then let "file_size_errors=file_fize_error+1"; echo -e "\n***ERROR \n\n"; fi
